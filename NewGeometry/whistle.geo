...
Point(p+9) = {L_inlet+R+l2+l1+L_outlet,(D_inlet/2)+H_inlet,W_outlet/2,MeshFactor};
Point(p+10) = {L_inlet+R+l2+l1,(D_inlet/2)+H_inlet,W_outlet/2,MeshFactor};
...
//outlet
Point(p+12) = {L_inlet+R+l2+l1+L_outlet,(D_inlet/2),W_outlet/2,MeshFactor};
...
//Side Wall outlet
Point(p+14) = {L_inlet+R+l2+l1,(D_inlet/2),W_outlet/2,MeshFactor};
Point(p+15) = {L_inlet+R+l2+l1,(D_inlet/2),-W_outlet/2,MeshFactor};
Line(l+17) = {p+12,p+14};
Line(l+18) = {p+14,p+10};
Line Loop(s+5) = {l+17:l+18,-42,-45};
...
Point(p+16) = {L_inlet+R+l2,(D_inlet/2)-R-l3,W_outlet/2,MeshFactor};
...
// //SideWallFront
// Point(p+10) = {L_inlet+R,(D_inlet/2)-R,W_outlet/2,MeshFactor}; //center


// Circle(l+11)= {p+2,p+10,p+11};
